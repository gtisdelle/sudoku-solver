'''
 ...
 Sudoku is a classic constraint satisfaction problem and contains a
 partial candidate solution where it can be quickly and trivialy determined
 whether it can possibly be completed into a valid solution.
 
 I was inspired to solve the problem for a sudoku board and attained most of
